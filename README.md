...
![cadence report: a table of per-label latency distributions with a histogram column, a deadline verdict reading MISSED with 153 of 190 iterations inside budget, and a breakdown of the three slowest iterations by stage](docs/report.svg)
