    ...
    class ScopedKernel {
       public:
        ...
        ~ScopedKernel() {
            ...
            detail::ThreadState& state = detail::TlsState();
            Append(state, detail::DeviceRecord{labelId_, true, stream_, start_, stop_, detail::ElapsedNs(hostStart_, hostEnd)});
        }
    ...
    class ScopedStage {
       public:
        ...
        ~ScopedStage() {
            ...
            chain->tail = stop;
            chain->generation = generation_;
            Append(state, detail::DeviceRecord{labelId_, ownsStart_, stream_, start_, stop, detail::ElapsedNs(hostStart_, hostEnd)});
        }
