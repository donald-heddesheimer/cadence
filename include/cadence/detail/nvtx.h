...
//
// Every scope can also push an NVTX range, so the same instrumentation shows up on an Nsight Systems timeline. When no tool is attached the push/pop pair is a couple of nanoseconds; when NVTX is absent it compiles to nothing.
#pragma once
